...
const image1Btn = document.querySelector(".image-1");
const image2Btn = document.querySelector(".image-2");
const image3Btn = document.querySelector(".image-3");
const headerContainer = document.querySelector("header");

image1Btn.addEventListener("click", () => {
  headerContainer.classList.remove("slideshow-header");
  headerContainer.style.backgroundImage = "url('royal-suite/2.JPG')";
});

image2Btn.addEventListener("click", () => {
  headerContainer.classList.remove("slideshow-header");
  headerContainer.style.backgroundImage = "url('dulex-room/1.JPG')";
});

image3Btn.addEventListener("click", () => {
  headerContainer.classList.remove("slideshow-header");
  headerContainer.style.backgroundImage = "url('executive-twinbed/1.JPG')";
});
